...
![Map of La Palma](images/la-palma-map.png){#fig-map fig-alt="Map of La Palma where La Palma is marked in red." fig-align="center"}

La Palma is one of the west most islands in the Volcanic Archipelago of the Canary Islands (@fig-map).

{{< embed notebooks/explore-earthquakes.qmd#tbl-yearly-earthquakes >}}

@tbl-yearly-earthquakes show the yearly number of earthquakes on La Palma.
