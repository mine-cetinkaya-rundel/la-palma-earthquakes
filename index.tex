...
Studies of the magma systems feeding the volcano, such as (Marrero et
al., 2019), have proposed that there are two main magma reservoirs
feeding the Cumbre Vieja volcano; one in the mantle (30-40km depth)
which charges and in turn feeds a shallower crustal reservoir (10-20km
depth).
...
\caption{\label{fig-timeline}Timeline of recent eruptions on La Palma
Source:
\href{https://mine-cetinkaya-rundel.github.io/la-palma-earthquakes/index.qmd.html}{Article
Notebook}}
...
Table~\ref{tbl-history} summarizes the eruptions recorded since the
...
\textbf{?@tbl-yearly-earthquakes} shows the yearly number of earthquakes
on La Palma.
...
since 2017. Source:
\href{https://mine-cetinkaya-rundel.github.io/la-palma-earthquakes/notebooks/data-screening.ipynb.html\#cell-fig-spatial-plot}{Data
Screening}}

\end{figure}

Figure~\ref{fig-spatial-plot} shows the locations of recent earthquakes
on La Palma.
...
Marrero, J. M., García, A., Berrocoso, M., Llinares, Á.,
Rodríguez-Losada, A., \& Ortiz, R. (2019). Strategies for the
